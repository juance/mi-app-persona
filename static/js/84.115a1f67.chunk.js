...
`,m=function(e){let r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"ARS";return new Intl.NumberFormat("es-AR",{style:"currency",currency:r}).format(e)},g=e=>{let{transactions:r,exchangeRate:a=1.1}=e;const[g,h]=(0,o.useState)("total"),v=r.filter((e=>"income"===e.type)).reduce(((e,r)=>e+r.amount),0),f=r.filter((e=>"expense"===e.type)).reduce(((e,r)=>e+r.amount),0),y=v-f,b=y*a,j=v*a,w=f*a,k=r.filter((e=>{var r;return(null===(r=e.platform)||void 0===r?void 0:r.toLowerCase().includes("efectivo"))||!e.platform})),C=r.filter((e=>e.platform&&!e.platform.toLowerCase().includes("efectivo"))),S=k.filter((e=>"income"===e.type)).reduce(((e,r)=>e+r.amount),0),A=k.filter((e=>"expense"===e.type)).reduce(((e,r)=>e+r.amount),0),E=S-A,T=C.filter((e=>"income"===e.type)).reduce(((e,r)=>e+r.amount),0),z=C.filter((e=>"expense"===e.type)).reduce(((e,r)=>e+r.amount),0),I=T-z;let D,N,$,P,M,O;switch(g){case"cash":D=E,N=S,$=A,P=E*a,M=S*a,O=A*a;break;case"digital":D=I,N=T,$=z,P=I*a,M=T*a,O=z*a;break;default:D=y,N=v,$=f,P=b,M=j,O=w}const R=t.Ay.div`
    display: flex;
    margin-bottom: 20px;
