...
`,m=function(e){let r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"ARS";return new Intl.NumberFormat("es-AR",{style:"currency",currency:r}).format(e)},g=e=>{let{transactions:r,exchangeRate:a=1.1}=e;const[g,h]=(0,o.useState)("total"),v=r.filter((e=>"income"===e.type)).reduce(((e,r)=>e+r.amount),0),f=r.filter((e=>"expense"===e.type)).reduce(((e,r)=>e+r.amount),0),y=v-f,b=y*a,j=v*a,w=f*a,k=r.filter((e=>{var r;return(null===(r=e.platform)||void 0===r?void 0:r.toLowerCase().includes("efectivo"))||!e.platform})),C=r.filter((e=>e.platform&&!e.platform.toLowerCase().includes("efectivo"))),S=k.filter((e=>"income"===e.type)).reduce(((e,r)=>e+r.amount),0),A=k.filter((e=>"expense"===e.type)).reduce(((e,r)=>e+r.amount),0),E=S-A,T=C.filter((e=>"income"===e.type)).reduce(((e,r)=>e+r.amount),0),z=C.filter((e=>"expense"===e.type)).reduce(((e,r)=>e+r.amount),0),I=T-z;let D,$,N,P,M,O;switch(g){case"cash":D=E,$=S,N=A,P=E*a,M=S*a,O=A*a;break;case"digital":D=I,$=T,N=z,P=I*a,M=T*a,O=z*a;break;default:D=y,$=v,N=f,P=b,M=j,O=w}const R=t.Ay.div`
    display: flex;
    margin-bottom: 20px;
...
`,Ge={cash:["Efectivo","Caja chica","Caja fuerte"],virtual:["Mercado Pago","Banco Naci\xf3n","Banco Galicia","Ual\xe1","Brubank","Naranja X","Prex"]},Ue=e=>{let{onClose:r,onPlatformsChange:a}=e;const[t,s]=(0,o.useState)({cash:[],virtual:[]}),[l,c]=(0,o.useState)(""),[d,p]=(0,o.useState)("virtual");(0,o.useEffect)((()=>{try{const e=localStorage.getItem("cashPlatforms"),r=localStorage.getItem("virtualPlatforms"),a=e?JSON.parse(e):Ge.cash,o=r?JSON.parse(r):Ge.virtual;s({cash:a,virtual:o})}catch(e){console.error("Error al cargar plataformas:",e),s(Ge)}}),[]);const u=(e,r)=>{s((a=>({...a,[e]:a[e].filter(((e,a)=>a!==r))})))};return(0,i.jsxs)(Ae,{children:[(0,i.jsxs)(Ee,{children:[(0,i.jsx)(Te,{children:"Gestionar Plataformas"}),(0,i.jsx)(ze,{onClick:r,children:(0,i.jsx)(n.yGN,{})})]}),(0,i.jsxs)(Ie,{children:[(0,i.jsx)(De,{type:"cash",children:"Efectivo"}),(0,i.jsx)($e,{children:t.cash.map(((e,r)=>(0,i.jsxs)(Ne,{children:[(0,i.jsx)(Pe,{children:e}),(0,i.jsx)(Me,{onClick:()=>u("cash",r),children:(0,i.jsx)(n.IXo,{})})]},r)))})]}),(0,i.jsxs)(Ie,{children:[(0,i.jsx)(De,{type:"virtual",children:"Billeteras Virtuales"}),(0,i.jsx)($e,{children:t.virtual.map(((e,r)=>(0,i.jsxs)(Ne,{children:[(0,i.jsx)(Pe,{children:e}),(0,i.jsx)(Me,{onClick:()=>u("virtual",r),children:(0,i.jsx)(n.IXo,{})})]},r)))})]}),(0,i.jsxs)(Oe,{onSubmit:e=>{e.preventDefault(),l.trim()&&(s((e=>({...e,[d]:[...e[d],l.trim()]}))),c(""))},children:[(0,i.jsxs)(Fe,{value:d,onChange:e=>p(e.target.value),children:[(0,i.jsx)("option",{value:"cash",children:"Efectivo"}),(0,i.jsx)("option",{value:"virtual",children:"Billetera Virtual"})]}),(0,i.jsx)(Re,{type:"text",placeholder:"Nombre de la plataforma",value:l,onChange:e=>c(e.target.value)}),(0,i.jsxs)(_e,{type:"submit",disabled:!l.trim(),children:[(0,i.jsx)(n.GGD,{}),"Agregar"]})]}),(0,i.jsxs)(Le,{onClick:()=>{try{localStorage.setItem("cashPlatforms",JSON.stringify(t.cash)),localStorage.setItem("virtualPlatforms",JSON.stringify(t.virtual)),a&&a(t),alert("Plataformas guardadas correctamente")}catch(e){console.error("Error al guardar plataformas:",e),alert("Error al guardar plataformas")}},children:[(0,i.jsx)(n.Bc_,{}),"Guardar Cambios"]}),(0,i.jsx)("div",{style:{marginTop:"16px",textAlign:"right"},children:(0,i.jsx)("button",{onClick:()=>{s(Ge)},style:{background:"none",border:"none",color:"var(--text-medium)",textDecoration:"underline",cursor:"pointer",fontSize:"0.9rem"},children:"Restaurar valores predeterminados"})})]})},Je=t.Ay.div`
  background-color: var(--bg-light);
  border-radius: var(--border-radius);
  padding: 24px;
  margin-bottom: 24px;
...
`,Dr=e=>{let{data:r,filename:a="export"}=e;const[t,s]=(0,o.useState)(!1),l=(0,o.useRef)(null),c=(0,h.zh)({opacity:t?1:0,transform:t?"translateY(0)":"translateY(-20px)",config:{tension:300,friction:20}}),d=e=>{l.current&&!l.current.contains(e.target)&&s(!1)};o.useEffect((()=>(t?document.addEventListener("mousedown",d):document.removeEventListener("mousedown",d),()=>{document.removeEventListener("mousedown",d)})),[t]);return(0,i.jsxs)(Sr,{ref:l,children:[(0,i.jsxs)(Ar,{variant:"outline",onClick:()=>{s(!t)},children:[(0,i.jsx)(n.a4x,{}),"Exportar"]}),t&&(0,i.jsxs)(Er,{style:c,children:[(0,i.jsxs)(Tr,{children:["Exportar datos",(0,i.jsx)(Ir,{onClick:()=>s(!1),children:(0,i.jsx)(n.yGN,{})})]}),(0,i.jsxs)(zr,{onClick:()=>{(0,Cr.GF)(r,a),s(!1)},children:[(0,i.jsx)(n.jH2,{}),"Exportar como CSV"]}),(0,i.jsxs)(zr,{onClick:()=>{(0,Cr.Uh)(r,a),s(!1)},children:[(0,i.jsx)(n.Hbo,{}),"Exportar como JSON"]}),(0,i.jsxs)(zr,{onClick:()=>{(0,Cr.bJ)(r,`${a}.xlsx`),s(!1)},children:[(0,i.jsx)(n.jH2,{}),"Exportar como Excel"]})]})]})},$r=(0,t.Ay)(h.CS.div)`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`,Rr=e=>{let{isOpen:r,onClose:a,onConfirm:o,title:t="Confirmar",children:n,confirmText:s="Confirmar",cancelText:l="Cancelar",confirmVariant:c="primary"}=e;const d=(0,h.zh)({opacity:r?1:0,config:{tension:300,friction:20}}),p=(0,h.zh)({opacity:r?1:0,transform:r?"translateY(0)":"translateY(-50px)",config:{tension:300,friction:20}});return r?(0,i.jsx)($r,{style:d,onClick:a,children:(0,i.jsxs)(Nr,{style:p,onClick:e=>e.stopPropagation(),children:[(0,i.jsx)(Pr,{children:t}),(0,i.jsx)(Mr,{children:n}),(0,i.jsxs)(Or,{children:[(0,i.jsx)(re.A,{variant:"outline",onClick:a,fullWidth:window.innerWidth<=480,children:l}),(0,i.jsx)(re.A,{variant:c,onClick:()=>{o(),a()},fullWidth:window.innerWidth<=480,children:s})]})]})}):null};var Fr=a(8090);const _r=t.Ay.div`
  max-width: 1200px;
  margin: 0 auto;
`,Lr=t.Ay.div`
  margin-bottom: 36px;
