"use strict";(self.webpackChunkmi_app_personal=self.webpackChunkmi_app_personal||[]).push([[217],{7217:(r,e,a)=>{a.r(e),a.d(e,{default:()=>Fr});var o=a(5043),t=a(5464),n=a(6058),i=a(7304),s=a(2771),l=a(579);i.t1.register(i.Bs,i.m_,i.s$,i.PP,i.kc,i.E8,i.hE);const c=t.Ay.div`
...
`,F={name:"",target_amount:"",current_amount:"0",category:"savings",deadline:""},I=r=>{let{onSubmit:e,onCancel:a,goal:t}=r;const[n,i]=(0,o.useState)(t||F),[s,c]=(0,o.useState)(""),[d,u]=(0,o.useState)([]);(0,o.useEffect)((()=>{(()=>{const r=k();u(r)})()}),[]);const p=r=>{const{name:e,value:a}=r.target;i((r=>({...r,[e]:a})))};return(0,l.jsxs)(A,{children:[(0,l.jsx)(_,{children:"Crear Nuevo Objetivo Financiero"}),s&&(0,l.jsx)(C,{children:s}),(0,l.jsxs)("form",{onSubmit:r=>{r.preventDefault(),n.name.trim()?!n.target_amount||parseFloat(n.target_amount)<=0?c("Por favor ingresa un monto objetivo v\xe1lido."):parseFloat(n.current_amount)>parseFloat(n.target_amount)?c("El monto actual no puede ser mayor que el monto objetivo."):(e({...n,target_amount:parseFloat(n.target_amount),current_amount:parseFloat(n.current_amount||0)}),i(F),c("")):c("Por favor ingresa un nombre para el objetivo.")},children:[(0,l.jsxs)(S,{children:[(0,l.jsx)(E,{htmlFor:"name",required:!0,children:"Nombre del objetivo"}),(0,l.jsx)(N,{type:"text",id:"name",name:"name",value:n.name,onChange:p,required:!0})]}),(0,l.jsxs)(S,{children:[(0,l.jsx)(E,{htmlFor:"target_amount",required:!0,children:"Monto objetivo (ARS)"}),(0,l.jsx)(N,{type:"number",id:"target_amount",name:"target_amount",min:"1",step:"0.01",value:n.target_amount,onChange:p,required:!0})]}),(0,l.jsxs)(S,{children:[(0,l.jsx)(E,{htmlFor:"current_amount",children:"Monto actual (ARS)"}),(0,l.jsx)(N,{type:"number",id:"current_amount",name:"current_amount",min:"0",step:"0.01",value:n.current_amount,onChange:p})]}),(0,l.jsxs)(S,{children:[(0,l.jsx)(E,{htmlFor:"category",required:!0,children:"Categor\xeda"}),(0,l.jsx)(z,{id:"category",name:"category",value:n.category,onChange:p,required:!0,children:d.map((r=>(0,l.jsx)("option",{value:r.value,children:r.name},r.value)))})]}),(0,l.jsxs)(S,{children:[(0,l.jsx)(E,{htmlFor:"deadline",children:"Fecha l\xedmite"}),(0,l.jsx)(N,{type:"date",id:"deadline",name:"deadline",value:n.deadline,onChange:p})]}),(0,l.jsx)($,{type:"submit",children:"Guardar Objetivo"})]})]})};var D=a(5772);const q=t.Ay.div`
  background-color: var(--card-bg);
  border-radius: var(--border-radius);
  padding: 24px;
  box-shadow: var(--card-shadow);
...
`,rr=r=>{switch(r){case"savings":return(0,l.jsx)(D.z8N,{});case"investment":return(0,l.jsx)(D.ARf,{});case"purchase":return(0,l.jsx)(D.y52,{});case"travel":return(0,l.jsx)(D.HzC,{});case"education":return(0,l.jsx)(D.H9b,{});case"home":return(0,l.jsx)(D.V5Y,{});default:return(0,l.jsx)(D.x_j,{})}},er=r=>new Intl.NumberFormat("es-AR",{style:"currency",currency:"ARS"}).format(r),ar=r=>{if(!r)return"Sin fecha l\xedmite";return new Date(r).toLocaleDateString("es-ES")},or=r=>{let{goal:e,onUpdate:a,onDelete:o}=r;const t=Math.min(100,Math.round(e.current_amount/e.target_amount*100));return(0,l.jsxs)(q,{children:[(0,l.jsxs)(M,{children:[(0,l.jsx)(P,{children:rr(e.category)}),(0,l.jsx)(O,{children:e.name})]}),(0,l.jsxs)(R,{children:[(0,l.jsxs)(G,{children:[(0,l.jsx)(Y,{children:"Actual:"}),(0,l.jsx)(B,{type:"current",children:er(e.current_amount)})]}),(0,l.jsxs)(G,{children:[(0,l.jsx)(Y,{children:"Objetivo:"}),(0,l.jsx)(B,{type:"target",children:er(e.target_amount)})]})]}),(0,l.jsxs)(U,{children:[(0,l.jsx)(J,{children:(0,l.jsx)(T,{progress:t})}),(0,l.jsxs)(W,{children:[t,"%"]})]}),(0,l.jsxs)(H,{children:[(0,l.jsxs)(V,{children:[(0,l.jsx)(X,{children:"Fecha l\xedmite:"}),(0,l.jsx)(L,{children:ar(e.deadline)})]}),(0,l.jsxs)(Z,{children:[(0,l.jsx)(K,{onClick:()=>a(e.id),children:"Actualizar"}),(0,l.jsx)(Q,{onClick:()=>o(e.id),children:"\ud83d\uddd1\ufe0f"})]})]})]})},tr=t.Ay.div`
  display: grid;
...
`,kr=t.Ay.div`
  ...
  font-style: italic;
  padding: 20px 0;
`,Ar=r=>{let{categories:e,onSaveCategories:a}=r;const[t,n]=(0,o.useState)(e||[]),[i,s]=(0,o.useState)(""),[c,d]=(0,o.useState)(""),[u,p]=(0,o.useState)(-1),[g,m]=(0,o.useState)(""),[x,b]=(0,o.useState)(""),[h,v]=(0,o.useState)(!1),[f,y]=(0,o.useState)(!1),[j,w]=(0,o.useState)(null);(0,o.useEffect)((()=>{n(e||[])}),[e]);const k=()=>{if(!g.trim()||!x.trim())return;const r=[...t];r[u]={name:g.trim(),value:x.trim()},n(r),p(-1),v(!0)},A=()=>{p(-1)};return(0,l.jsxs)(sr,{children:[(0,l.jsx)(lr,{children:"Gestionar Categor\xedas"}),(0,l.jsxs)(xr,{onSubmit:r=>{if(r.preventDefault(),!i.trim()||!c.trim())return;const e={name:i.trim(),value:c.trim()};n([...t,e]),s(""),d(""),v(!0)},children:[(0,l.jsx)(br,{type:"text",placeholder:"Nombre de categor\xeda",value:i,onChange:r=>s(r.target.value),required:!0}),(0,l.jsx)(br,{type:"text",placeholder:"Valor (ej: travel)",value:c,onChange:r=>d(r.target.value),required:!0}),(0,l.jsxs)(hr,{type:"submit",variant:"primary",children:[(0,l.jsx)(D.GGD,{})," Agregar"]})]}),(0,l.jsx)(cr,{children:t.length>0?t.map(((r,e)=>(0,l.jsx)(dr,{children:u===e?(0,l.jsxs)(jr,{children:[(0,l.jsx)(wr,{type:"text",value:g,onChange:r=>m(r.target.value),required:!0}),(0,l.jsx)(wr,{type:"text",value:x,onChange:r=>b(r.target.value),required:!0}),(0,l.jsx)(mr,{onClick:k,color:"var(--secondary-color)",children:(0,l.jsx)(D.YrT,{})}),(0,l.jsx)(mr,{onClick:A,color:"var(--danger-color)",children:(0,l.jsx)(D.yGN,{})})]}):(0,l.jsxs)(l.Fragment,{children:[(0,l.jsxs)("div",{children:[(0,l.jsx)(ur,{children:r.name}),(0,l.jsxs)(pr,{children:["Valor: ",r.value]})]}),(0,l.jsxs)(gr,{children:[(0,l.jsx)(mr,{onClick:()=>(r=>{p(r),m(t[r].name),b(t[r].value)})(e),color:"var(--primary-color)",children:(0,l.jsx)(D.WXf,{})}),(0,l.jsx)(mr,{onClick:()=>(r=>{if(window.confirm("\xbfEst\xe1s seguro de que deseas eliminar esta categor\xeda?")){const e=t.filter(((e,a)=>a!==r));n(e),v(!0)}})(e),color:"var(--danger-color)",children:(0,l.jsx)(D.IXo,{})})]})]})},e))):(0,l.jsx)(kr,{children:"No hay categor\xedas personalizadas. Agrega una nueva."})}),h&&(0,l.jsx)(vr,{onClick:async()=>{try{y(!0),w(null);await a(t)?(v(!1),w({type:"success",text:"Categor\xedas guardadas correctamente. Se han sincronizado con la nube."})):w({type:"error",text:"No se pudieron guardar las categor\xedas en la nube, pero se guardaron localmente."})}catch(r){console.error("Error al guardar categor\xedas:",r),w({type:"error",text:"Error al guardar categor\xedas: "+(r.message||"Error desconocido")})}finally{y(!1)}},variant:"primary",disabled:f,children:f?(0,l.jsxs)(l.Fragment,{children:[(0,l.jsx)(fr,{children:(0,l.jsx)(D.TwU,{})})," Guardando..."]}):(0,l.jsxs)(l.Fragment,{children:[(0,l.jsx)(D.Bc_,{})," Guardar Cambios"]})}),j&&(0,l.jsxs)(yr,{type:j.type,children:["success"===j.type?(0,l.jsx)(D.YrT,{}):(0,l.jsx)(D.yGN,{}),j.text]})]})};var _r=a(8090);const Cr=t.Ay.div`
  max-width: 1200px;
  margin: 0 auto;
`,Sr=t.Ay.div`
  margin-bottom: 36px;
